...
void read_Sensors() {
  ...
  all_sensor_values = "sv_" + String(sensor_1_value) + "," + String(sensor_2_value) + "," + String(sensor_3_value) + "," + String(sensor_4_value) + "," + String(sensor_5_value) + "," + String(sensor_6_value) + "," + String(sensor_7_value) + "," + String(sensor_8_value) + "," + String(sensor_9_value) + "," + String(plug_in_but_no_charge_counter) + "," + String(no_charging_counter) + "," + String(idle_no_charging_counter) + "," + String(charge_counter) + "," + swser1_serial_string.substring(0, swser1_serial_string.length() - 1) + "lv_" + String(sum_of_power / 3600) + "ec_" + error_code_1 + error_code_2 + error_code_3 + error_code_4 + error_code_5 + error_code_6 + error_code_7 + error_code_8 + error_code_9 + error_code_10 + error_code_11 + error_code_12 + error_code_13 + error_code_14 + error_code_15 + error_code_16 + error_code_17 + "ecl_";
