...
void read_Sensors() {
  ...
  all_sensor_values = "sv_" + String(voltage_1) + "," + String(current_1) + "," + String(power_1) + "," + String(energy_1) + "," + String(frequency_1) + "," + String(pf_1) + "," + String(voltage_2) + "," + String(current_2) + "," + String(power_2) + "," + String(energy_2) + "," + String(frequency_2) + "," + String(pf_2) + "," + String(voltage_3) + "," + String(current_3) + "," + String(power_3) + "," + String(energy_3) + "," + String(frequency_3) + "," + String(pf_3) + "," + String(wifi_strength) + "," + String(sensor_8_value) + "," + String(sensor_9_value) + "," + String(plug_in_but_no_charge_counter) + "," + String(no_charging_counter) + "," + String(idle_no_charging_counter) + "," + String(charge_counter) + "lv_" + String(sum_of_power / 3600) + "ec_" + error_code_1 + error_code_2 + error_code_3 + error_code_4 + error_code_5 + error_code_6 + error_code_7 + error_code_8 + error_code_9 + error_code_10 + error_code_11 + error_code_12 + error_code_13 + error_code_14 + error_code_15 + error_code_16 + error_code_17 + "ecl_";
