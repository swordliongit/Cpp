...
void wifi_Http_Get_Request_For_Ota_Filename_Setup() {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    if (httpResponseCode > 0) {
      ...
      if (version_name.indexOf("attachment; filename*=UTF-8''ota_xsarj_group_0004_version_") >= 0 && version_name.indexOf(".bin") >= 0) {
        http_get_version = (version_name.substring(version_name.indexOf("attachment; filename*=UTF-8''ota_xsarj_group_0004_version_") + 58, version_name.indexOf(".bin"))).toInt();
