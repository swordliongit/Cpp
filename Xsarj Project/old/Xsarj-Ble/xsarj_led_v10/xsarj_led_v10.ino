...
class MyCallbacks: public BLECharacteristicCallbacks {
    void onWrite(BLECharacteristic *pCharacteristic) {
      ...
      if (rxValue.length() > 0) {
        ...
        if (data_from_ble.indexOf("p_") == 0 && data_from_ble.indexOf("!") > 0) {
          String swSer_string = data_from_ble.substring(data_from_ble.indexOf("p_") + 2 , data_from_ble.indexOf("!"));
          led_panel_status = (data_from_ble.substring(data_from_ble.indexOf("!") + 1 , data_from_ble.indexOf("*"))).toInt();
          if (led_panel_status == 1) {
            swSer.println("p_" + swSer_string + "!");
          }
        }
        if (data_from_ble.indexOf("r1") >= 0 && data_from_ble.indexOf("tp") >= 0) {
        ...
        if (data_from_ble.indexOf("tp") >= 0 && data_from_ble.indexOf("pz") >= 0) {
        ...
        if (data_from_ble.indexOf("pi") >= 0 && data_from_ble.indexOf("%") >= 0) {
        ...
        if (data_from_ble.indexOf("!") >= 0 && data_from_ble.indexOf("$") >= 0 && data_from_ble.indexOf("?") >= 0) {
