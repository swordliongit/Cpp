void change_wifi_Command() {
  if (second_esp_serial_data.startsWith("chwifi")) {
...
{
  EEPROM.write(50, config_1_value);
  EEPROM.write(51, config_2_value);
  EEPROM.write(52, config_3_value);
...
{
  config_1_value = int(EEPROM.read(50));
  config_2_value = int(EEPROM.read(51));
  config_3_value = int(EEPROM.read(52));
...
void arrange_Config_To_variables() {
