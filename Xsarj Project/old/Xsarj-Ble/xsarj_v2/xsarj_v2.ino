...
const char* emailsender_mail_adress = "bayramkebapevi@gmail.com";
const char* emailsender_mail_password = "Evi.1993";
char* emailtaker_mail_adress = "serhatbuyruk@hotmail.com";
...
void setup() {
  Serial.begin(115200);
  //Serial1.begin(9600);
  interface_serial.init(9600);

  //Start Com
  interface_serial.interface_send_bytes(INTERFACE_MSG_TYPE_START_COM, 0);
  interface_serial.interface_send_bytes(INTERFACE_MSG_TYPE_SET_NUM_OF_CURRENT, 13);
  //Start Charge
  //delay(1000);
  //Stop Charge
...
//  if (sensor_7_value < 2500) {
//    config_1_value = int(pow(charge_counter,0.333));
//    write_Int_ToEeprom();
//    delay(20000);
//  }
